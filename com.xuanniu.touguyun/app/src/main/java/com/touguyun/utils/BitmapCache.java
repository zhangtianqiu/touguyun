...
//						thumb = BitmapFactory.decodeFile(thumbPath);
                        ...
                        thumb = Images.decodeFile(thumbPath, 400, true);
                        if (thumb == null) {
                ...
                if (thumb == null && mContext != null) {
                    thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.default_header);
                }
