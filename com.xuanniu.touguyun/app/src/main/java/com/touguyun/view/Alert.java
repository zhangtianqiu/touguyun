...
public class Alert extends Dialog {
    ...
    public static class Builder {
        ...
        public Alert create() {
            ...
            View layout = View.inflate(context, R.layout.alert, null);
            if (null!=contentView){
            ...
            if (StringUtils.isEmpty(leftTitle)) {
                ...
                if(leftColor!=0){
                    ((Button) layout.findViewById(R.id.alert_bt_left)).setTextColor(leftColor);
                }
            ...
            if (StringUtils.isEmpty(rightTitle)) {
                ...
                if(rightColor!=0){
                    ((Button) layout.findViewById(R.id.alert_bt_right)).setTextColor(rightColor);
                }
